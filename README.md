...
> The template repo (and generated copies) execute source code from: [profile-icons/readme-repo-pins-src](https://github.com/profile-icons/readme-repo-pins-src)

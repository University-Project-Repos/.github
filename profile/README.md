...
🤓 Fun facts: 
- With exception to weekly 0.1% labs & "super assignments", I almost quit my first project & uni because of an ambiguous & arcane IDE bug discovered not until the very final moments with just enough time to unfix countless code - "smells" - changes, when excluding all free time - basically none. That is, when my eyes were not involuntarily closing from remote attacks & countles other such issues, including obscure co-requisite regulations initiating what is now infinite overtime. It was a software engineering project for a Java GUI app simulating charges & quotes for multiple parking lot plans. It helped prepare me though for my next & first project in both Agile, git and game development while on my first formal exchange abroad.
- [GitStats](https://github.com/R055A/GitStats) was initially deployed before a project including CI/CD visualising GitHub API-fetched stats for the first instance of an advanced data engineering course. Not the first case of unwittingly preempting assessments ahead of courses, nor the last of irony.

...
🤓 Fun facts: 
- With exception to weekly 1% labs & "super assignments", I almost quit my first project because of an ambiguous & invisible IDE bug fixed not until the final moments with just enough time to unfix countless code - "smells' - changes, when excluding all free time. That is, when my eyes were not involuntarily closing from remote attacks & countles other such issues. It was a software engineering project for a Java GUI app simulating charges & quotes for various parking lot plans. It helped prepare me though for my next & first project in both Agile & git development while on my first formal exchange abroad.

...
🤓 Fun facts: 
- With exception to weekly 0.1% labs & "super assignments", I almost quit my first IT project, & hence uni because of an ambiguous & arcane IDE bug discovered not until the very final moments with just enough time to unfix eternal erroneous code changes, when excluding all free time (because there isn't ever either). That is, when my eyes were not involuntarily closing from remote attacks (neither experienced before nor since, regardless of only just yrs convalesced from total hand-eye coordination devastation when almost outright losing them altogether to say the utmost least) & countless other such issues, including obscure co-requisite regulations initiating what is now infinite overtime (& would mention nocturnal lascivious home invasion attacks but I lost only sleep, which is nothing new nor old, & not like I also faced the most unnaturally uninhabitable (& root of all harm) "home" humanely imaginable when only legally residing in it). It was a [software engineering project for a Java GUI app simulating charges & quotes for multiple airport parking lot plans](https://github.com/University-Project-Repos/AirportParking). It helped prepare me though for my next & first project in both Agile, git & even game development while on my first formal exchange abroad, & every 100+ project since, bar one transcending far beyond the outer realms of any logic, reality & reason this puny little human can ever hope to remotely possibly attain to a level projected so grandoise & omnipotent (& utter blatant fanatical raving melodramatic (darknet) creep maniac lunacy, although must say high-IQ sounding, even if outright clinically compulsive violent psychosis ranting self-contradicting baby gaslight parasitic pretense, self-refuting by nature alone), or even fathom (considering already long evidently attained regardless of eternal epic (including multiple life obsession) true-crime efforts otherwise - with exception to the little only ever required - only not of my own so much one would assume it was bar 100+ projects instead as naturally obstinated, especially when the basis of this one project being the sole exception is the fashionably crazed gross neglect & serious misconduct to recognize the aforementioned first Agile & all other projects ironically credited at all prerequisites required to enrol in the first place - of which I alone inequitably required everything, & naturally did (to cause it on myself?!) &  this is just a walk in the park in comparison to how my contributions, such as in the stats, are treated or rather not ever - although the effects (cyclically treated as cause until catch-22 convergence limbo) clearly remaining significantly indefinite is something to take home & display on a wall with pride, not to mention the countless other adversity, such as total amnesia, motor-skill loss, paralyses, multiple severe infections head to toe, ongoing wound effects, more eye damages, countless device destruction, 24/7 insane wrongdoing plagues & enduced sleep deprivation, are just some of far too many to remember health, resource & other effects independently overcome, at least in the sense of academic performance, & yrs furthermore undermined & essentially brainwashing wasted to say the least singlehandedly dealing with this & in delays forevermore) in any founded non-extortive sound probability. If that's difficult to make sense of, welcome to the club.
- [GitStats](https://github.com/R055A/GitStats) was initially deployed before a project including CI/CD visualising GitHub API-fetched stats for the first instance of an advanced data engineering course. Not the first case of unwittingly preempting assessments ahead of courses, nor the last of irony at its extremist.

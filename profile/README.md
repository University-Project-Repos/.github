...
🤓 Fun facts: 
- With exception to weekly 0.1% labs & "super assignments", I almost quit my first IT project, & hence uni because of an ambiguous & arcane IDE bug discovered not until the very final moments with just enough time to unfix eternal erroneous code changes, when excluding all free time (because there isn't ever either). That is, when my eyes were not involuntarily closing from remote attacks (neither experienced before nor since, regardless of only just yrs convalesced from total hand-eye coordination devastation when almost outright losing them altogether to say the utmost least) & countless other such issues, including obscure co-requisite regulations initiating what is now infinite overtime (& would mention nocturnal lascivious home invasion attacks but I lost only sleep, which is nothing new nor old, & not like I also faced the most unnaturally uninhabitable "home" humanely imaginable when only legally residing in it). It was a [software engineering project for a Java GUI app simulating charges & quotes for multiple airport parking lot plans](https://github.com/University-Project-Repos/AirportParking). It helped prepare me though for my next & first project in both Agile, git & even game development while on my first formal exchange abroad, & every 100+ project since, bar one transcending far beyond the outer realms of any logic, reality & reason this puny little human can ever hope to remotely possibly attain to a level projected so grandoise & omnipotent (& utter blatant fanatical raving melodramatic creep maniac lunacy, although must say high-IQ, even if outright compulsive violent psychosis ranting baby gaslight pretense), or even fathom (considering already long evidently attained regardless of eternal epic efforts otherwise - with exception to the little only ever required - only not of my own so much one would assume it was bar 100+ projects instead as naturally obstinated, especially when the basis of this one project being the sole exception is the fashionably crazed gross neglect & serious misconduct to recognize the aforementioned first Agile & all other projects ironically credited at all prerequisites required to enrol in the first place - of which I alone inequitably required everything - although the effects clearly remaining significantly indefinite is something to take home & display on a wall with pride, not to mention the countless other adversity, such as total amnesia, motor-skill loss, paralyses, multiple severe infections head to toe, ongoing wound effects, more eye damages, countless device destruction, are just some of far too many to remember health & resource effects independently overcome, at least in the sense of academic performance, & yrs furthermore undermined & essentially wasted to say the least singlehandedly dealing with this & in delays forevermore) in any founded non-extortive sound probability.

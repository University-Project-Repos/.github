...
> The following are examples from over __100__ `.git` university projects, most completed pre-GenAI (& rather all under the most perfectly least of ideal circumstances), some since integrating LLM, many involving extensive collaboration, all averaging with distinction:

...
🤓 Fun facts: 
- With exception to weekly 0.1% labs & "super assignments", I almost quit my first IT project, & hence uni because of an ambiguous & arcane IDE bug discovered not until the very final moments with just enough time to unfix eternal erroneous code changes, when excluding all free time (because there isn't ever either). That is, when my eyes were not involuntarily closing from remote attacks (neither experienced before nor since, regardless of only just yrs convalesced from total motor-skill & hand-eye coordination devastation when almost outright losing them altogether to say the utmost least) & countles other such issues, including obscure co-requisite regulations initiating what is now infinite overtime (& would mention nocturnal home invasion attacks but I lost only sleep, which is nothing new nor old, & not like I also had to face the most unnaturally uninhabitable "home" humanely imaginable when only legally residing in it). It was a software engineering project for a Java GUI app simulating charges & quotes for multiple parking lot plans. It helped prepare me though for my next & first project in both Agile, git and even game development while on my first formal exchange abroad, & every of the 100+ projects since bar one transcending far beyond the outer limits of any logic & reality this puny little human can ever hope to possibly fathom in all probability.
